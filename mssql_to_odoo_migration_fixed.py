#!/usr/bin/env python3
"""
Complete MSSQL to Odoo Migration Script - Fixed Version
        ...
        try:
            ...
            for user in users:
                try:
                    ...
                    # Create customer using OdooService method
                    try:
                        ...
                        if "already exists" in str(e).lower():
                            ...
                            try:
                                ...
                                if existing_partners:
                                    self.id_mapping['users'][user_id] = existing_partners[0]
                                    self.migration_stats['customers_migrated'] += 1
                            except:
                                pass
                        else:
        ...
        try:
            ...
            for ticket in tickets:
                try:
                    ...
                    # Create ticket using OdooService method
                    try:
                        ...
                        self.migration_stats['errors'].append(f"Failed to create ticket {ticket_id}: {e}")
    ...
    def migrate_ticket_messages(self, mssql_ticket_id, odoo_ticket_id, cursor):
        ...
        try:
            ...
            for message in messages:
                ...
                try:
                    # Create message/note in Odoo ticket
                    if is_bot:
                        note_body = f"<p><strong>🤖 Bot Response:</strong></p><p>{content}</p>"
                    elif is_admin:
                        note_body = f"<p><strong>👨‍💼 Admin Reply:</strong></p><p>{content}</p>"
                    else:
                        note_body = f"<p><strong>👤 Customer:</strong></p><p>{content}</p>"
